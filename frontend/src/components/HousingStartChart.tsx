...
const HousingStartChart: React.FC<HousingStartChartProps> = ({ selectedMonth }) => {
        ...
        const fetchData = async () => {
            try {
                const results = await Promise.allSettled([
                    getData(13, selectedMonth),
                    getData(82, selectedMonth)
                ]);
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <p className="mt-4 text-gray-700 text-sm text-center">
                The chart above compares housing starts in Toronto and Hamilton, highlighting regional growth trends. Housing starts show new residential construction, providing data on urban expansion, economic activity, and housing supply. This data will help analysts evaluate development patterns, compare market dynamics, and support strategic planning for housing and infrastructure developments.
            </p>
        </div>
    );
};
