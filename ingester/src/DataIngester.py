...
#         """
#         self.db = DatabaseHandler(connect)
#         self.api_url = os.getenv("API_URL_HOUSING")
#         self.api_key = os.getenv("API_KEY")
...
#                     singles_starts = task["Singles_starts"],
#                     semis_starts = task["Semis_starts"],
#                     row_starts = task["Row_starts"],
#                     apartment_starts = task["Apt_Other_starts"],
#                     singles_complete = task["Singles_complete"],
#                     semis_complete = task["Semis_complete"],
#                     row_complete = task["Row_complete"],
#                     apartment_complete = task["Apt_other_complete"]
